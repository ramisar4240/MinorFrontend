...
import { tags } from "../Home/ProjectList/ProjectList";
...
const CreateProjectForm=()=>{
    ...
    <FormField control={form.control}  
                ...
                <DialogClose>
                 {false?<div><P>you can create only 3 project with free plan, please upgraded your plan </P></div> :(<Button type='submit' className="w-full mt-5">Create Project</Button>)}   
